...
<html>
    ...
    <body>
            ...
            <div class="container">				
                ...
                <nav id="nav">
                    <ul>
                        ...
                        <li><a href="<?php echo $host ?>index.php/estudiante/perfilEstudianteC">Perfil</a></li>
                        <?php
                        echo "<li><a href='".$host."index.php/reino/obtenerReinoEstudianteC?k_reino=".$_GET['k_reino']."'>Reino</a></li>"
                        ?>
        ...
        <div id="featured" style="padding-top: 5px; padding-bottom: 0px;" >           
            ...
            <iframe class="embed-responsive-item" src="/Arcadia/Ejecutable/index.html?k_actividad=5"></iframe>
            </div>
