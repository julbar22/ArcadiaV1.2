                ...
                if(global.n_intentos_realizados >= global.q_intentos){
                  ...
                  switch(global.k_tipo_actividad){
                    ...
                    case "2":
                      ...
                      $("#btnSubmitCuestionario").attr("onclick","this.form.action ='<?php echo $host ?>index.php/actividad/crearCuestionarioResuelto?k_actividad="+global.k_actividad+"&n_intentos="+global.n_intentos_realizados+"/"+global.q_intentos+"&k_reino="+reinoG+"'");
                    ...
                    case "1":
                      ...
                      $("#btnSubmitFile").attr("onclick","this.form.action = '<?php echo $host ?>index.php/Actividad/crearActividadResuelta?k_actividad="+global.k_actividad+"&n_intentos="+global.n_intentos_realizados+"/"+global.q_intentos+"&k_reino="+reinoG+"'");
                ...
                <div id="templatemo_main" >
                    <div id="templatemo_sidebar">
                        ...
                        <div id="templatemo_menu">
                            <ul>
                                <li><a href="<?php echo $host ?>index.php/estudiante/inicioEstudiante">Inicio<span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true" style="float: right;" ></a></li>
                                <li><a href="<?php echo $host ?>index.php/estudiante/perfilEstudianteC">Perfil<span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true" style="float: right;" ></a></li>
                                <?php
                                  echo "<li><a href='".$host."index.php/reino/obtenerReinoEstudianteC?k_reino=".$_GET['k_reino']."'>Reino<span class='glyphicon glyphicon-triangle-bottom' aria-hidden='true' style='float: right;' ></a></li>";

                                ?>
                                <li><a href="<?php echo $host ?>index.php/welcome/index">Salir<span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true" style="float: right;" ></a></li>
                            </ul>
                    ...
                    <div id="templatemo_content">
                      <?php
                      echo "<a align='center' href='".$host."index.php/reino/obtenerReinoEstudianteC?k_reino=".$_GET['k_reino']."'><input align='center' type='submit' value='Volver' id='btnSubmit' class='btn btn-info'></a>";
                            ...
                            <?php
                                    if (isset($regiones)) {
                                        for($i=0; $i<count($regiones);$i++){
                                            ...
                                            echo "<div><a href='".$host."index.php/Actividad/formularioCrearActividad?k_reino=".$_GET['k_reino']."&k_region=".$regiones[$i]['k_region']."' ></a></div>";
                                            ...
                                            for($j=0;$j<count($regiones[$i]['actividades']);$j++){
                                                ...
                                                if($regiones[$i]['actividades'][$j]['k_tipo_actividad']==1){
                                                  echo "<td><form method='post' action='".$host."index.php/Actividad/descargarDocumentoActividad?download_file=".$regiones[$i]['actividades'][$j]['n_anexo']->getNombre()."' role='form' class='form-inline'><button type='submit' id='Descargar' name='Descargar' class='btn btn-primary'>Descargar</button></form></td>";
                                                }
                                                else{
                                                  echo "<td></td>";
                                                }
            ...
            <div class="modal-content">
                <form method ='post' >
                        ...
                        <div id="modal_footer" class="modal-footer">
                            ...
                            <?php
                                echo "<input type='submit' value='Enviar Datos' id='btnSubmit' class='btn btn-success' onclick =\"this.form.action = '".$host."index.php/Actividad/actualizarActividad?k_reino=".$_GET['k_reino']."'\" >";
                            ?>
                        </div>
                    </form>
                </div>
