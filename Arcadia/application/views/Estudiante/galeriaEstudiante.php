                        ...
                        <div id="templatemo_menu">
                            ...
                            <ul>
                                ...
                                <ul class="menuhijos" id="menuNotas">
                                  <?php
                                  if (isset($perfilR)) {
                                      echo "<li><a href='".$host."index.php/reino/notasRegionEst?k_reino=".$perfilR[0]['k_reino']. "' ><span class='glyphicon glyphicon-pawn' aria-hidden='true'></span> Mostrar</a></a></li>";
                                  }
                                  ?>
                                ...
                                <ul class="menuhijos" id="menuActividades">
                                    <?php
                                    if (isset($perfilR)) {
                                        echo "<li><a href='".$host."index.php/reino/actividadesRegionEst?k_reino=".$perfilR[0]['k_reino']. "' ><span class='glyphicon glyphicon-pawn' aria-hidden='true'></span> Misiones por Región</a></a></li>";
                                    }
                                    ?>
                                </ul>
