        ...
        <div class="col-md-8 col-md-offset-2 form-registro">
            <form method="post" name="form1">
              ...
              //        print_r($clases);
                    ...
                    <input type="submit" class="btn btn-success" onclick = "this.form.action = '<?php echo $host ?>index.php/Estudiante/registrarEstudiante'" value="Registrarse" />
                    <a href="<?php echo $host ?>index.php/Welcome/index" ><input type="button" class="btn btn-info" value="Cancelar" /></a>
