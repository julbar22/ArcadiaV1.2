        ...
        <script type="text/javascript" charset="utf-8" async defer>
            ...
            $(document).ready(function () {
                ...
                $('#myCanvas').click(function(e){
                     window.location.href = "<?php echo $host ?>index.php/reino/mapaActividadesProfesorC?k_reino="+$('#idReino').val();
                              ...
                              <?php
                                if(isset($galeria)){
                                   ...
                                   if($galeria['videos'] != null){
                                    ...
                                    echo "</div>";
                                    echo "<a href='".$host."index.php/reino/cargarGaleriaProfesor?k_reino=".$perfilR[0]['k_reino']."'><strong>Mirar Galeria</strong></a></div>";
                                }
                              ?>
                              <div class="content_box">
