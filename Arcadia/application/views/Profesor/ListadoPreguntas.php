        ...
        <script type="text/javascript" charset="utf-8" async defer>
            ...
            function eliminarPregunta(idPregunta){
               // alert(idPregunta);
                ...
                ?>;
                 window.location.href='<?php echo $host ?>index.php/pregunta/eliminarPregunta?k_reino='+idReino+'&k_pregunta='+idPregunta;
            }
                ...
                <div id="templatemo_main" >
                    <div id="templatemo_sidebar">
                        ...
                        <div id="templatemo_menu">
                                ...
                                <?php
                                    if(isset($reinoId)){
                                          echo "<li><a href='".$host."index.php/reino/obtenerReinoProfesorC?k_reino=".$reinoId."'>Reino<span class='glyphicon glyphicon-triangle-bottom' aria-hidden='true' style='float: right;' ></a></li>";
                                    }else{
         ...
         <div id="myModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <form action="<?php echo $host ?>index.php/pregunta/crearPregunta" method ="post">
