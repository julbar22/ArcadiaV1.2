                ...
                <div id="templatemo_main" >
                    ...
                    <div id="templatemo_content">
                        ...
                        <div class="content_box">
                            <?php
                                    echo "<a href='".$host."index.php/reino/obtenerReinoProfesorC?k_reino=".$_GET['k_reino']."'><input type='submit' value='Volver' id='btnSubmit' class='btn btn-info'></a>";
                                        ...
                                        for($i=0; $i<count($listaEstudiantes);$i++){
                                          ...
                                          echo "<td>
                                                    <form method ='post' name = 'form' class='form-horizontal' enctype='multipart/form-data'>
                                                        <input type='submit' value='Ver Misiones' id='btnSubmit' class='btn btn-success' onclick = \"this.form.action = '".$host."index.php/Actividad/listaMisionesEstudiante?k_estudiante=".$listaEstudiantes[$i]->getNickname()."&k_reino=".$_GET['k_reino']."' \">
                                                    </form>
                                                </td>";
                                          echo "<tr>";
                                      }
