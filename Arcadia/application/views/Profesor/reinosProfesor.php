    ...
    <body>
        ...
        <div id="header">
            <div class="container">				
                ...
                <nav id="nav">
                    <ul>
                        <li><a href="<?php echo $host ?>index.php/profesor/inicioProfesor">Inicio</a></li>						
                            ...
                            <div class="panel-body">
                                ...
                                <div class="input-group">
                                    ...
                                    if (isset($perfil)) {
                                        ...
                                        ?>
                                    <br>
                                    <input id="actualizarDatos" type="submit" class="btn btn-success" style="display:none;"  onclick = "this.form.action = '<?php echo $host ?>index.php/Profesor/actualizarDatosProfesorC'" value="Guardar Cambios"></input>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    for ($i = 0; $i < count($reinos) / 4; $i++) {
                        ...
                        for ($h = 0; $h < 4; $h++) {
                            if ($j < count($reinos)) {
                                $a = $reinos[$j]['k_reino'];
                                echo "<div class='3u'>";
                                echo "<form method='get' action='".$host."index.php/reino/obtenerReinoProfesorC' >";
                                echo "<section>";
