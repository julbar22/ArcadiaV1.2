                ...
                <div id="templatemo_main" >
                    ...
                    <div id="templatemo_content">
                        ...
                        <div class="content_box">
                            <?php
                                    if (isset($actividad)) {
                                        echo "<a href='".$host."index.php/reino/actividadesRegion?k_reino=".$_GET['k_reino']."'><input type='submit' value='Volver' id='btnVolver' class='btn btn-info'></a>";
                                        ...
                                        for($i=0; $i<count($estudiantes);$i++){
                                            ...
                                            switch ($respuestas[$i]['anexo']) {
                                              ...
                                              case "Actividad en Clase":
                                                  ...
                                                  break;
                                              default:
                                                  echo "<td><form method='post' action='".$host."index.php/Actividad/descargarDocumentoActividad?download_file=".$respuestas[$i]['anexo']."' role='form' class='form-inline'><button type='submit' id='Descargar' name='Descargar' class='btn btn-primary'>Descargar</button></form></form></td>";
                                                  echo "<input id='Bota".$i."' name='Bota".$i."' type='hidden' size='1' style='text-align:center;' disabled='true' class='form-control' aria-describedby='basic-addon1' value='".$respuestas[$i]['nota']."'>";
                                                  echo "<td><input id='Nota".$i."' name='Nota".$i."' step='0.01' type='number' min='0' max='10' size='1' style='text-align:center;' disabled='true' class='form-control' aria-describedby='basic-addon1' value='".$respuestas[$i]['nota']."'>"."<input id='Id".$i."' name='Id".$i."' type='hidden' disabled='true' value='".$respuestas[$i]['Id']."'>"."</td>";
                                                  break;
                                            }
                                        ...
                                        echo "<input type='submit' value='Actualizar Notas' id='btnSubmit' name='btnSubmit' class='btn btn-success' disabled='disabled' onclick = \"this.form.action = '".$host."index.php/Actividad/actualizarActividadNota?k_actividad=".$_GET['k_actividad']."&k_reino=".$_GET['k_reino']."' \">";
                                        echo "</form>";
                                    }
