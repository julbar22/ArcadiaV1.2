        ...
        <script type="text/javascript" charset="utf-8" async defer>
            var  $myCanvas;
              ...
              function miFuntionAlert(data, idRegion){
                    ...
                    $('#urlCrearActividad').attr("href", "<?php echo $host ?>index.php/Actividad/formularioCrearActividad?k_reino="+idReino+"&k_region="+idRegion);
                    ...
                    <div class="container-fluid" style="padding-left:0px;">
                        <div class="collapse navbar-collapse" style="padding-left:0px;" id="bs-example-navbar-collapse-9">
                            <ul class="nav navbar-nav"> 
                                ...
                                <?php
                                  echo "<li><a href='".$host."index.php/reino/obtenerReinoProfesorC?k_reino=".$_GET['k_reino']."'>Reino</a></li>";
                                                                 
                                ?>
                                
                                <li><a href="<?php echo $host ?>index.php/profesor/inicioProfesor">Inicio</a></li> 
                                <li><a href="<?php echo $host ?>index.php/profesor/perfilProfesorC">Perfil</a></li> </ul>
                        </div>
                      </div>
                    </nav>      
