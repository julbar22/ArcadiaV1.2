            ...
            <div id="templatemo_wrapper">
                ...
                <div id="templatemo_main" >
                          ...
                          <ul>
                              <li><a onclick="desplegar('Inicio');">Inicio<span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true" style="float: right;" ></a></li>
                                  <ul class="menuhijos" id="menuInicio">
                                      <li><a href="<?php echo $host ?>index.php/profesor/inicioProfesor"><span class="glyphicon glyphicon-pawn" aria-hidden="true"></span> Inicio</a></li>
                                      <li><a href="<?php echo $host ?>index.php/profesor/perfilProfesorC"><span class="glyphicon glyphicon-pawn" aria-hidden="true"></span> Perfil</a></li>
                                  </ul>
                              ...
                              <ul class="menuhijos" id="menuNotas">
                                  <?php
                                      if (isset($perfilR)){
                                          echo "<li><a href='".$host."index.php/reino/notasTotales?k_reino=".$perfilR[0]['k_reino']. "' ><span class='glyphicon glyphicon-pawn' aria-hidden='true'></span> Notas</a></li>";
                                      }
                                  ?>
                              ...
                              <ul class="menuhijos" id="menuActividades">
                                  <?php
                                  if (isset($perfilR)) {
                                      echo "<li><a href='".$host."index.php/reino/actividadesRegion?k_reino=".$perfilR[0]['k_reino']. "' ><span class='glyphicon glyphicon-pawn' aria-hidden='true'></span> Misiones Por Region</a></li>";
                                      echo "<li><a href='".$host."index.php/reino/listaEstudiantesReino?k_reino=".$perfilR[0]['k_reino']. "' ><span class='glyphicon glyphicon-pawn' aria-hidden='true'></span> Misiones Por Estudiante</a></li>";
                                      echo "<li><a href='".$host."index.php/pregunta/listadoPreguntasC?k_reino=".$perfilR[0]['k_reino']. "' ><span class='glyphicon glyphicon-pawn' aria-hidden='true'></span> Listado de Preguntas</a></li>";
                                  }
                                  ?>
                              </ul>
                        ...
                        echo "<div class='sidebar_box'>";
                            ...
                            echo"<form method='post'>";
                              echo "<div class='form-group'>";
                                ...
                                echo "<br />";
                                echo "<input type='submit' value='Enviar' style='display:none;' nombre='btnNovedad' id='btnNovedad' class='btn btn-success' onclick = \"this.form.action = '".$host."index.php/Reino/crearNovedad?k_reino=".$_GET['k_reino']."' \">";
                              echo "</div>";
                            echo "</form>";
                    ...
                    <div id="templatemo_content">
                        ...
                        <?php
                        echo "<a align='center' href='".$host."index.php/reino/obtenerReinoProfesorC?k_reino=".$_GET['k_reino']."'><input align='center' type='submit' value='Volver' id='btnSubmit' class='btn btn-info'></a>";
                    ...
                    <form method ='post' enctype="multipart/form-data">
                        ...
                        <div id="body_modal" class="modal-body">
                           <div id="modalform" class="form-group">
                              ...
                              <?php
                                  echo "<center><input type='submit' value='Enviar Datos' id='btnSubmit' class='btn btn-success' onclick = \"this.form.action = '".$host."index.php/reino/actualizarGaleria?k_reino=".$_GET['k_reino']."' \"></center>";
                              ?>
                            </div>
                         </div>
                    </form>
