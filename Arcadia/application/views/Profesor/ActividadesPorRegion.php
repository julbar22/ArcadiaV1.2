        ...
        <script type="text/javascript" charset="utf-8" async defer>
         var global;
            ...
            function eliminarActividad(){
                 ...
                 window.location.href = "<?php echo $host ?>index.php/actividad/eliminarActividadC?k_reino="+idReino+"&k_actividad="+global.k_actividad;
            }
                ...
                <div id="templatemo_main" >
                    <div id="templatemo_sidebar">
                        ...
                        <div id="templatemo_menu">
                            <ul>
                                <li><a href="<?php echo $host ?>index.php/profesor/inicioProfesor">Inicio<span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true" style="float: right;" ></a></li>
                                <li><a href="<?php echo $host ?>index.php/profesor/perfilProfesorC">Perfil<span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true" style="float: right;" ></a></li>
                                <?php
                                  echo "<li><a href='".$host."index.php/reino/obtenerReinoProfesorC?k_reino=".$_GET['k_reino']."'>Reino<span class='glyphicon glyphicon-triangle-bottom' aria-hidden='true' style='float: right;' ></a></li>";
                                ?>
                            ...
                            <?php
                                    if (isset($regiones)) {
                                        for($i=0; $i<count($regiones);$i++){
                                            ...
                                            echo "<div><a href='".$host."index.php/Actividad/formularioCrearActividad?k_reino=".$_GET['k_reino']."&k_region=".$regiones[$i]['k_region']."' ><input  style='width: 100%;' class='btn btn-default' type='button' value='Añadir Actividad en ".$regiones[$i]['n_nombre']."' ></a></div>";
                                                ...
                                                if($regiones[$i]['actividades'][$j]['i_estado'] == "Cerrada"){
                                                    echo "<td>
                                                              <form method ='post' name = 'form' class='form-horizontal' enctype='multipart/form-data'>
                                                                  <input type='submit' value='Respuestas' id='btnSubmit' class='btn btn-success' onclick = \"this.form.action = '".$host."index.php/Actividad/listaEstudianteEnMision?k_actividad=".$regiones[$i]['actividades'][$j]['k_actividad']."&k_reino=".$_GET['k_reino']."' \">
                                                              </form>
                                                          </td>";
                                                } else {
                                                    echo "<td>"."</td>";
