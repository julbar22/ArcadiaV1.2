                ...
                <div id="templatemo_main" >
                    ...
                    <form method ="post" name = "formCrearActividad" class="form-horizontal" enctype="multipart/form-data">
                       ...
                       <!-- hasta aqui va el div de preguntas -->
                            <?php
                                echo "<input type='submit' value='Enviar Datos' id='btnSubmit' class='btn btn-success' onclick = \"this.form.action = '".$host."index.php/Actividad/crearActividad?k_reino=".$_GET['k_reino']."&k_region=".$_GET['k_region']."' \">";
                            ?>
