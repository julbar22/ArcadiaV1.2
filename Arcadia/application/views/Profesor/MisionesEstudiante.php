                ...
                <div id="templatemo_main" >
                    ...
                    <div id="templatemo_content">
                        ...
                        <div class="content_box">
                            <?php
                                    if (isset($regiones)) {
                                        echo "<a href='".$host."index.php/reino/listaEstudiantesReino?k_reino=".$_GET['k_reino']."'><input type='submit' value='Volver' id='btnSubmit' class='btn btn-info'></a>";
                                        ...
                                        for($i=0; $i<count($regiones);$i++){
                                            ...
                                            for($j=0;$j<count($regiones[$i]['actividades']);$j++){
                                                ...
                                                if($regiones[$i]['actividades'][$j]['i_estado'] == "Activa"){
                                                    ...
                                                    switch ($respuestas[$i][$j]['anexo']) {
                                                      ...
                                                      default:
                                                        $flag ++;
                                                        echo "<td><form method='post' action='".$host."index.php/Actividad/descargarDocumentoActividad?download_file=".$respuestas[$i][$j]['anexo']."' role='form' class='form-inline'><button type='submit' id='Descargar' name='Descargar' class='btn btn-primary'>Descargar</button></form></td>";
                                                        echo "<input id='Bota".$i.$j."' name='Bota".$i.$j."' type='hidden' size='1' style='text-align:center;' disabled='true' class='form-control' aria-describedby='basic-addon1' value='".$respuestas[$i][$j]['nota']."'>";
                                                        echo "<td><input id='Nota".$i.$j."' name='Nota".$i.$j."' step='0.01' type='number' min='0' max='10' size='1' style='text-align:center;' disabled='true' class='form-control' aria-describedby='basic-addon1' value='".$respuestas[$i][$j]['nota']."'>"."<input id='Id".$i.$j."' name='Id".$i.$j."' type='hidden' disabled='true' value='".$respuestas[$i][$j]['Id']."'>"."</td>";
                                                        break;
                                                    }
                                            ...
                                            if ($flag > 0){
                                              ...
                                              echo "<input type='submit' disabled='disabled' value='Actualizar Notas' id='btnSubmit".$i."' class='btn btn-success' onclick = \"this.form.action = '".$host."index.php/Actividad/actualizarNota?k_estudiante=".$_GET['k_estudiante']."&k_reino=".$_GET['k_reino']."' \"> ";
                                            }
                                            echo "</form></br></br>";
                                        }
